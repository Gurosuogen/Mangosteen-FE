...
import { mockItemSummary, mockItemIndexBalance, mockItemIndex, mockTagEdit, mockItemCreate, mockSession, mockTagIndex, mockTagShow } from "../mock/mock";
...
const mock = (response: AxiosResponse) => {
    if (true || location.hostname !== 'localhost'
        ...
        && location.hostname !== '192.168.0.110') { return false }
